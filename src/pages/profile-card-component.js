...
import imgWorkCover from '../assets/image/jpg/details/profile-card-component-1.jpg'
import imgS1 from '../assets/image/jpg/details/profile-card-component.png'
              ...
              <Col lg='8'>
                <Box>
                  ...
                  <Title className='my-4'>
                    Profile Card Component <br /> Frontend Mentor Project.
                  </Title>
                  <Text
                    variant='p'
                    css={`
          ...
          <Container>
            <Row>
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://github.com/foxwayne1/profile-card-component'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://fm-profile-card-component-wf.netlify.app/'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://www.frontendmentor.io/challenges/profile-card-component-cfArpWshJ'>
                  <a target='_blank'>
