...
import imgWorkCover from "../assets/image/jpg/details/reviews-main.png";
import imgS1 from "../assets/image/jpg/details/reviews-github.png";
            ...
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  ...
                  <Title className="my-4">Reviews</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://github.com/foxwayne1/reviews">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://wf-reviews.netlify.app/">
                  <a target="_blank">
