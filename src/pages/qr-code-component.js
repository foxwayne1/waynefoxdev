...
import imgWorkCover from '../assets/image/jpg/details/qr-code-component-1.jpg'
import imgS1 from '../assets/image/jpg/details/qr-code-component.png'
              ...
              <Col lg='8'>
                <Box>
                  ...
                  <Title className='my-4'>
                    QR Code Component <br /> Frontend Mentor Challenge.
                  </Title>
                  <Text
                    variant='p'
                    css={`
          ...
          <Container>
            <Row>
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://github.com/foxwayne1/qr-code-component'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://fm-qr-code-component-wf.netlify.app/'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://www.frontendmentor.io/challenges/qr-code-component-iux_sIO_H'>
                  <a target='_blank'>
