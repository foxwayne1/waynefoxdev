...
import imgWorkCover from "../assets/image/jpg/details/panellum-main.png";
import imgS1 from "../assets/image/jpg/details/panellum-github.png";
        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">HTML, CSS, JAVASCRIPT, PANNELLUM JS</Text>
                  <Title className="my-4">Pannellum JS</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >
                    Using Pannellum JS to build a basic setup for a company
                    developer test.
                  </Text>
                </Box>
              </Col>
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://github.com/foxwayne1/Pannellum-test-streamGo">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://panellum-test-streamgo.netlify.app/">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://pannellum.org/">
                  <a target="_blank">
                    <Button arrowRight>Pannellum JS</Button>
                  </a>
                </Link>
              </Col>
            </Row>
