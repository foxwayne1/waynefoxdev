...
import imgWorkCover from "../assets/image/jpg/details/guess-my-number-main.png";
import imgS1 from "../assets/image/jpg/details/guess-my-number-netlify.png";
        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">HTML, CSS, JAVASCRIPT</Text>
                  <Title className="my-4">Guess My Number</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >
                    Fabulous JavaScript priject building out a number game.
                  </Text>
                </Box>
              </Col>
            </Row>
        ...
        <div className="mt-lg-3">
          <Container>
            <Row>
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://guess-my-number-wfox.netlify.app/">
                  <a target="_blank">
