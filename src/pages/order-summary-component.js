...
import imgWorkCover from '../assets/image/jpg/details/order-summary-component-1.jpg'
import imgS1 from '../assets/image/jpg/details/order-summary-component.png'
        ...
        <Section hero>
          <Container>
            <Row className='justify-content-center text-center'>
              <Col lg='8'>
                <Box>
                  <Text variant='tag'>HTML, CSS</Text>
                  <Title className='my-4'>
                    Order Summary Component <br /> Frontend Mentor Challenge.
                  </Title>
                  <Text
                    variant='p'
                    css={`
                    ...
                    `}
                  >
                    A great starter project built using HTML and CSS stored on
                    Githhub and deployed with Netlify.
                  </Text>
                </Box>
              </Col>
            </Row>
          ...
          <Container>
            <Row>
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://github.com/foxwayne1/order-summary-component'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://fm-order-summary-component-wf.netlify.app/'>
                  <a target='_blank'>
              ...
              <Col lg='4' className='mb-4 mb-lg-0'>
                <Link href='https://www.frontendmentor.io/challenges/order-summary-component-QlPmajDUj#content'>
                  <a target='_blank'>
