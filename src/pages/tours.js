...
import imgWorkCover from "../assets/image/jpg/details/tours-main.png";
import imgS1 from "../assets/image/jpg/details/tours-github.png";
            ...
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  ...
                  <Title className="my-4">Tours</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >
                    A React JS based Tours website loading data from API.
                  </Text>
                </Box>
              </Col>
            </Row>
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://github.com/foxwayne1/tours">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://wf-tours.netlify.app/">
                  <a target="_blank">
