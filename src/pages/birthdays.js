...
import imgWorkCover from "../assets/image/jpg/details/birthday-main.png";
import imgS1 from "../assets/image/jpg/details/birthday-github.png";
        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">HTML, CSS, REACT JS</Text>
                  <Title className="my-4">Birthdays Reminder</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >
                    A React JS based Birthday Reminder.
                  </Text>
                </Box>
              </Col>
            </Row>
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://github.com/foxwayne1/birthday-reminder">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://wf-birthday-list.netlify.app/">
                  <a target="_blank">
