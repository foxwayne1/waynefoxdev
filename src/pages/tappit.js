...
import imgWorkCover from "../assets/image/jpg/details/tappit-main.png";
import imgS1 from "../assets/image/jpg/details/tappit-github.png";
          ...
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">
                    HTML, CSS, REACT JS, TAILWIND, PAGINATION
                  </Text>
                  <Title className="my-4">Tappit</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >
                    A React JS based company challenge to build a table with
                    pagination.
                  </Text>
                </Box>
              </Col>
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://github.com/foxwayne1/tappit-wfox">
                  <a target="_blank">
              ...
              <Col lg="4" className="mb-4 mb-lg-0">
                <Link href="https://tappit-wfox.netlify.app/">
                  <a target="_blank">
